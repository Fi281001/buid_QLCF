		...
		<div style="width: 800px; min-height: 525px;">
			<table style="width: 800px; text-align: center;">
				...
				<tr>
					...
					<td style="width: 100px; border: 1px solid">Mã loại</td>
				...
				<form method="post" action="sanpham?update2=<%=sp.getMacafe()%>">
					...
					<td >
			   		<input style="" type="submit" name="submit" value="Cập nhật"/>
			   		</td>
				</form>
					<td style=" border: 1px solid"><a href="sanpham?xoa2=<%=sp.getMacafe()%>">XOÁ</a></td>
				</tr>
				<%} %>
			</table>
		</div>
		 ...
		 display: flex; justify-content: center; margin-top: 20px;padding-left: 20px;">
			<div style="width: 500px; min-height: 400px; position: relative;">
				...
				<form action="upcf" enctype= "multipart/form-data" method="post">
						...
						Mã Loại: <input style="margin-bottom: 20px; margin-left: 46px; width: 370px; text-align: right;"
						 type="text" name="txtmh" value="<%=(session.getAttribute("sanpham")!=null)?sanpham.getMaLoai():""%>"> <br>
						 
						Số lượng: <input style="margin-bottom: 20px; margin-left: 50px; width: 370px; text-align: right;"
